  ...
  function calculator(){
    ...
    switch(operator){
      ...
      case '/': 
        ...
        return
      case '%':
        setCurrentNumber((fistNumber * lastNumber / 100 + "%"))
        return
    }
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttons}>
        ...
        <TouchableOpacity onPress={() => handleInput(button)} key={button} style={[styles.button, {backgroundColor: '#311d59'}]}>
